...
-- Insert Owner account (password: owner123)
-- Note: wallet_address can be updated later when owner connects their MetaMask wallet
INSERT INTO users (
    email, 
    password_hash, 
    name, 
    ...
    '$2a$12$QJun/yZN9VqX1Jh90yst3.sQP7TUptdHirq4JQrw.sWakrB2JvYsK',
    'System Owner',
    '0900000000',
    'OWNER',
    NULL,
...
SELECT 'Database dropped and recreated successfully! Owner account created.' AS message;